...
import ga.ozli.groovylicious.loader.bus.EventBusSubscriber
import ga.ozli.groovylicious.loader.bus.GModEventBus
import ga.ozli.groovylicious.loader.bus.type.ForgeBus
import ga.ozli.groovylicious.loader.bus.type.ModBus
...
final class GModContainer extends ModContainer {
    ...
    private void injectBus() {
        log.debug('Injecting buses into mod {}, with class {}', modId, modClass)
        mod.modBus = getModBus()
        mod.forgeBus = MinecraftForge.EVENT_BUS
        log.debug('Successfully injected buses into mod {}, with class {}', modId, modClass)
    }
